        ...
        <div className="projects-container">
          <div className="project-card">
            <div className="project-content">
              ...
              <h2>Project 1</h2>
              <p>Short description of the first project and its key features</p>
            </div>
            <div className="expanded-content">
              <h2>Project 1</h2>
              <p>Type of Project</p>
              <p>Time Frame of Project</p>
              <p>Project Description and Goal</p>
          ...
          <div className="project-card">
            <div className="project-content">
              <div className="project-image"></div>
              <h2>Project 2</h2>
              <p>Short description of the second project and its key features</p>
            </div>
            <div className="expanded-content">
              <h2>Project 2</h2>
              <p>Type of Project</p>
          ...
          <div className="project-card">
            <div className="project-content">
              <div className="project-image"></div>
              <h2>Project 3</h2>
              <p>Short description of the third project and its key features</p>
            </div>
            <div className="expanded-content">
              <h2>Project 3</h2>
              <p>Type of Project</p>
